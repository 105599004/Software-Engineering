...
<% List<Record> record_list = (List<Record>) session.getAttribute("record"); %>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
                    	...
                    	<div class="card">
                            ...
                            <div class="card-body">
                            	<table style="width:100%">
                            		...
                            		<form action="Submitstatus" method="GET">   
                                    	<%for (int i=0;i<record_list.size() ;i++){%>
											<tr>
												<td><%=record_list.get(i).getStudentID()%></td>
												<td><%=record_list.get(i).getScore()%></td>
												<td><input type="text" name="newScore" value=<%=record_list.get(i).getScore()%>></td>
											</tr>
										<%}%>
                                    </form>   
