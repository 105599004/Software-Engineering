...
%>
<%@page import="java.util.List"%>
<% List<Homework> homework_list = (List<Homework>) session.getAttribute("homework"); %>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <!-- Sidebar Header-->
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="Information"> <i class="icon-grid"></i>帳號資訊 </a></li>
            <li class="active"><a href="T_Homework"> <i class="icon-grid"></i>作業管理 </a></li>
          </ul>
        </nav> <!--最左邊那一排-->
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">作業管理</h2>
            </div>
          </header>
         <section class="forms">
         	<div class="container-fluid">
                    	...
                    	<div class="card">
                            ...
                            <div class="card-body">
                            	<table style="width:100%">
                                    ...
                                    <form action="T_Homework" method="GET">   
                                    	<%for (int i=0;i<homework_list.size() ;i++){%>
											<tr>
												<td><%=homework_list.get(i).getId()%></td>
												<td><%=homework_list.get(i).getDate()%></td>
												<td><%=homework_list.get(i).getDescription()%></td>
												<td><a href="Submitstatus">繳交狀態</a></td>
												<td><input type="button" value="刪除作業" class="btn btn-secondary" onclick="location.href='homework.html'"></td>
											</tr>
										<%}%>
                                    </form>                            
                                </table>
                            ...
                            <div class="modal-footer">
                            	<input type="button" value="新增作業" class="btn btn-primary" onclick="location.href='AddHomework'">
                            </div>
                       </div>
                    </div>
                </div>
