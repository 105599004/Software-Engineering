...
<%
	...
	System.out.println("homepage name: " + user.getName());
	System.out.println("homepage account: " + user.getAccount());
	System.out.println("homepage password: " + user.getPassword());
	System.out.println("homepage email: " + user.getEmail());
%>
<!DOCTYPE html>
<html>
  <head>
