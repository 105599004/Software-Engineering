                            	...
                            	<table style="width:100%">
                                    ...
                                    <form action="T_Homework" method="GET">
                                    	<c:forEach var="homework" items="${homework}">
                                    		<tr>
                                    			<td>
	                                    			<span id="homeworkname">
	                                    				${homework.getId()}
	                                    			</span>
	                                    		</td>
	                                    		<td>
	                                    			<span id="homeworkdataline">
	                                    				${homework.getDate()}
	                                    			</span>
	                                    		</td>
                                    			<td>
	                                    			<span id="homeworkdescription">
	                                    				${homework.getDescription()}
	                                    			</span>
	                                    		</td>
	                                    			<a href="homepage">繳交狀態</a>
	                                    		<td>
	                                    			<input type="button" value="刪除作業" class="btn btn-secondary" onclick="location.href='homework.html'">
	                                    		</td>
	                                    	</tr>
                                    	</c:forEach>
                                    </form>                            
